...
using DataToDocx.Services;
using DataToDocx.ViewModels.Pages;
using DataToDocx.ViewModels.Windows;
using DataToDocx.Views.Pages;
using DataToDocx.Views.Windows;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<TemplatePage>();
